        ...
        async def test_command(ctx, *args):
            ...
            async with ctx.typing():
                ...
                if validserver and adminrights:
                    ...
                    total_number_of_messages_checked = 0
                    for channel in public_ct:
                        ...
                        async for msg in channel.history(limit=L):
                            ...
                            if dayage > days:
                                ...
                                message_counter += 1
                                total_number_of_messages_checked += 1
                        ...
                        await ctx.channel.send(f'Checked #{channel.name};  {message_counter} messages')
                    ...
                    if mdmonly:
                        ...
                        for msg in messages:
                            ...
                            await ctx.send(embed=embed)
                    await ctx.send(f"total number of messages checked: {total_number_of_messages_checked}")
                else:
                    await ctx.channel.send(f'An error ocurred.')
