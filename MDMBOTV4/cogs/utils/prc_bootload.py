...
class BootLoadFunctions():
    ...
    def create_necessary_databases(bot) -> None:
        ...
        try:
            ...
            curT.execute('''CREATE TABLE IF NOT EXISTS reaction_embeds_multipage_current (embed_type text, guild_id integer, channel_id integer, message_id integer, current_page integer, utc_timestamp integer)''')
